...
- **STEP 0 — you run this, before editing. Sky does nothing.** Pin the gate: `npm run typecheck` · `npx jest --ci -w 3` · `npm run lint` (baseline on `bc91789` was typecheck 0 / lint 0 errors + 78 pre-existing warnings; jest never captured).

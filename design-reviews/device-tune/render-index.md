...
| a11y-tree/tasks-final__light__390.txt | tasks-final | light | 390 | rest | web-approximated | RN-web ARIA snapshot |
| a11y-tree/tasks-final-sheet__light__390.txt | tasks-final-sheet | light | 390 | sheet-open | web-approximated | RN-web ARIA snapshot |
| phase4/chip/home-peek-chip__light__390__peek-empty-local.png | home-peek-chip | light | 390 | peek-empty-local | web-approximated | D4/C5 — placement B (Sky's A-5 pick): the empty-local sentence as an ENGINEERED chip on the peek. Arbiter PASS 5.45:1 light / 5.57:1 dark over worst-case map tiles. |
| phase4/chip/home-peek-chip__dark__390__peek-empty-local.png | home-peek-chip | dark | 390 | peek-empty-local | web-approximated | D4/C5 — placement B (Sky's A-5 pick): the empty-local sentence as an ENGINEERED chip on the peek. Arbiter PASS 5.45:1 light / 5.57:1 dark over worst-case map tiles. |
| phase4/chip/home-peek-chip__light__390__peek-empty-local-zoom13.png | home-peek-chip | light | 390 | peek-empty-local-zoom13 | web-approximated | D4/C5 — placement B (Sky's A-5 pick): the empty-local sentence as an ENGINEERED chip on the peek. Arbiter PASS 5.45:1 light / 5.57:1 dark over worst-case map tiles. 130% type — the chip must wrap, never truncate. |
| phase4/chip/home-peek-chip__light__390__peek-located.png | home-peek-chip | light | 390 | peek-located | web-approximated | D4/C5 — placement B (Sky's A-5 pick): the empty-local sentence as an ENGINEERED chip on the peek. Arbiter PASS 5.45:1 light / 5.57:1 dark over worst-case map tiles. Control: flags nearby, so NO chip — it must not appear when there is something to show. |
| a11y-tree/home-peek-chip__light__390.txt | home-peek-chip | light | 390 | peek-empty-local | web-approximated | RN-web ARIA snapshot |
| a11y-tree/home-peek-chip__light__390.txt | home-peek-chip | light | 390 | peek-empty-local | web-approximated | RN-web ARIA snapshot |

...
<!-- AGENT-PROPOSED (QA 2026-08-18, closes S11): the Nominatim sentence above was added for 5.1.1(i) accuracy — the reviewer notes already disclosed it, the policy didn't. SUPERSEDED by d7b33fd (2026-08-31, "fix(copy): remove release-blocking em dashes"): Sky's ratified punctuation is the period, matching docs/privacy/index.html and copy.ts. -->

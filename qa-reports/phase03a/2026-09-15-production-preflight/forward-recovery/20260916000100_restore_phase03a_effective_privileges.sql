-- FORWARD RESTORATION of 20260905073925_phase03a_effective_privileges.
-- Generated by scripts/canonical-migration-identity.mjs (STAGE-MF-08).
--
-- Undoes 20260905073925_phase03a_effective_privileges.sql. This is a NEW forward migration with its own canonical
-- version (20260916000100), NOT a deletion or rewrite of that candidate's

-- FORWARD RESTORATION of 20260904000200_adopt_d1sa_containment.
-- Generated by scripts/canonical-migration-identity.mjs (STAGE-MF-08).
--
-- Undoes 20260904000200_adopt_d1sa_containment.sql. This is a NEW forward migration with its own canonical
-- version (20260916000900), NOT a deletion or rewrite of that candidate's

-- FORWARD RESTORATION of 20260905055632_phase03a_profile_updates.
-- Generated by scripts/canonical-migration-identity.mjs (STAGE-MF-08).
--
-- Undoes 20260905055632_phase03a_profile_updates.sql. This is a NEW forward migration with its own canonical
-- version (20260916000500), NOT a deletion or rewrite of that candidate's

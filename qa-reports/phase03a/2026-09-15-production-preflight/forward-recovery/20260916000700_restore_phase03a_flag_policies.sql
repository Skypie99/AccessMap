-- FORWARD RESTORATION of 20260905055629_phase03a_flag_policies.
-- Generated by scripts/canonical-migration-identity.mjs (STAGE-MF-08).
--
-- Undoes 20260905055629_phase03a_flag_policies.sql. This is a NEW forward migration with its own canonical
-- version (20260916000700), NOT a deletion or rewrite of that candidate's

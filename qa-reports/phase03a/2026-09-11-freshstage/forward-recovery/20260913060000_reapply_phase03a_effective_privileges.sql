-- FORWARD RE-APPLICATION of 20260905073925_phase03a_effective_privileges.sql.
-- STAGE-MF-08 forward-only recovery: re-applying a candidate that was deliberately
-- undone is ANOTHER new forward version (20260913060000), never a re-run of the original

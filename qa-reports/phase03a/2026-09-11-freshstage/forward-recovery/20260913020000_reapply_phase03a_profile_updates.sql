-- FORWARD RE-APPLICATION of 20260905055632_phase03a_profile_updates.sql.
-- STAGE-MF-08 forward-only recovery: re-applying a candidate that was deliberately
-- undone is ANOTHER new forward version (20260913020000), never a re-run of the original

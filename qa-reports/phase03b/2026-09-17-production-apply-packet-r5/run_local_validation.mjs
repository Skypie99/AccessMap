...
try {
  ...
  receipt.children.push(await run('LOCAL_R5_CONTROL_VALIDATION', 'validate_r5_controls.mjs'));
  ...
  const branchChild = receipt.children.find((child) => child.label === 'LOCAL_R5_CONTROL_VALIDATION');
  receipt.newControllerBranchTests = {
...
console.log(JSON.stringify({
  ...
  newControllerBranchTests: receipt.newControllerBranchTests,

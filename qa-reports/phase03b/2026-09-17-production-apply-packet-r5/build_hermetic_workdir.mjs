#!/usr/bin/env node
// Local-only R5 builder. It creates a minimal Supabase workdir containing only
...
import { assertExactInventory, EXPECTED, EXPECTED_FILENAMES } from './r5_control_lib.mjs';
...
export function buildHermeticWorkdir(outputPath) {
  ...
  writeFileSync(join(output, 'supabase/config.toml'), [
    'project_id = "flagstone-phase03b-hermetic-r5"',
    '',
    '[db]',
    'major_version = 17',
    '',

...
-- It captures no row payloads or query text.
begin transaction read only;
select jsonb_build_object(
  'receipt','phase03b_server_state_r4',
  ...
  'function_oid',to_regprocedure('private.flagstone_phase03b_block_row_lifecycle_r2()')::oid,
  'function_owner',(select pg_catalog.pg_get_userbyid(p.proowner) from pg_catalog.pg_proc p join pg_catalog.pg_namespace n on n.oid=p.pronamespace where n.nspname='private' and p.proname='flagstone_phase03b_block_row_lifecycle_r2' and pg_catalog.pg_get_function_identity_arguments(p.oid)=''),
  ...
  'truncate_gate_trigger_oid',(select oid from pg_catalog.pg_trigger where tgrelid='public.flags'::pg_catalog.regclass and tgname='aaa_flagstone_phase03b_truncate_quiescence_r3' and not tgisinternal),
  'truncate_gate_enabled',(select tgenabled from pg_catalog.pg_trigger where tgrelid='public.flags'::pg_catalog.regclass and tgname='aaa_flagstone_phase03b_truncate_quiescence_r3' and not tgisinternal),

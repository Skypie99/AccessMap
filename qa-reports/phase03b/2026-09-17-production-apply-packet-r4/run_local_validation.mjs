...
try {
  ...
  receipt.children.push(await run('LOCAL_R4_CONTROL_VALIDATION', 'validate_r4_controls.mjs'));
  const checks = receipt.children.flatMap((child) => Object.entries(child.payload?.checks ?? {}));

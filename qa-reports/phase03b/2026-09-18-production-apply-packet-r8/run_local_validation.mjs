...
try {
  ...
  receipt.children.push(await run('LOCAL_R8_CONTROL_VALIDATION', 'validate_r8_controls.mjs'));
  ...
  const branchChild = receipt.children.find((child) => child.label === 'LOCAL_R8_CONTROL_VALIDATION');

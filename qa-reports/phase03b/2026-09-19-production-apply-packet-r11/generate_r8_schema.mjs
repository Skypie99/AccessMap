...
const comparatorExpectedKeys = ['result', 'gateManifestSha256', 'finalLedgerSha256', 'finalStructureSha256', 'databaseT0', 'maximumQuiescenceWindowSeconds'];
...
const entryNonNegative = [
  ...
  'http_response_count', 'http_response_new_since_t0_count', 'pg_net_ttl_seconds', 'phase03b_ledger_count', 'lock_wait_ms', 'pre_install_flags_id_status_count',
...
Object.assign(entryStateProperties, {
  ...
  database_t0: utc, pg_net_ttl: { type: 'string', minLength: 1 }, pg_net_ttl_seconds: positive,
});
...
const schema = {
  ...
  $id: 'flagstone.phase03b.r8-envelope.v1',
  title: 'Flagstone Phase 03B R8 exact safety envelope',
  type: 'object',
  additionalProperties: false,
  required: [
  ...
  properties: {
    schemaVersion: { const: 'flagstone.phase03b.r8-envelope.v1' }, packetVersion: { const: 'R8' },
    ...
    producer: { type: 'string', minLength: 1 }, producerVersion: { const: 'flagstone.phase03b.packet-r8.v1' },
  ...
  $defs: {
    ...
    entryExpected: exactObject(['candidateSha', 'candidateTree', 'productionTarget', 'gateManifestSha256', 'migrationFilenames', 'databaseT0', 'maximumQuiescenceWindowSeconds'], {
      candidateSha: { const: '9d638456fa8e679678c54f131fe8f0db723eda72' },
      candidateTree: { const: 'cfc76206f7cf7af6a7127a6329620d2ee1dc4da8' }, productionTarget: { const: 'kldlwszpfkdmsjrjhjym' },
      gateManifestSha256: sha256, databaseT0: utc, maximumQuiescenceWindowSeconds: { const: 600 }, migrationFilenames: { type: 'array', minItems: 2, maxItems: 2, prefixItems: [
    ...
    migrationInventory: exactObject(['schemaVersion', 'packetVersion', 'target', 'candidate', 'candidateTree', 'workspaceRoot', 'migrationFileCount', 'seedFiles', 'roleFiles', 'otherSqlFiles', 'files'], {
      schemaVersion: { const: 1 }, packetVersion: { const: 'R8' }, target: { const: 'kldlwszpfkdmsjrjhjym' },
    ...
    serverExpected: exactObject(['gateManifestSha256', 'acceptedLedgerCounts', 'productionTarget', 'databaseT0', 'maximumQuiescenceWindowSeconds'], {
      gateManifestSha256: sha256, acceptedLedgerCounts: { type: 'array', minItems: 3, maxItems: 3, items: nonNegative },
      productionTarget: { const: 'kldlwszpfkdmsjrjhjym' }, databaseT0: utc, maximumQuiescenceWindowSeconds: { const: 600 },
    }),
    ...
    serverSnapshotSuccess: {
      ...exactObject(serverSnapshotKeys, {
        querySucceeded: { const: true }, receipt: { const: 'phase03b_server_state_r8' }, captured_at_utc: utc,
        ...
        history_count: nonNegative, history_sha256: sha256, database_t0: utc,
        pg_net_ttl: { type: 'string', minLength: 1 }, pg_net_ttl_seconds: positive, http_queue_count: nonNegative,
        http_response_count: nonNegative, http_response_sha256: sha256, http_response_new_since_t0_count: nonNegative,
      }),
      ...
      properties: { ...Object.fromEntries(serverSnapshotKeys.map((key) => [key, {}])),
        ...
        history_count: nonNegative, history_sha256: sha256, database_t0: utc,
        pg_net_ttl: { type: 'string', minLength: 1 }, pg_net_ttl_seconds: positive, http_queue_count: nonNegative,
        http_response_count: nonNegative, http_response_sha256: sha256, http_response_new_since_t0_count: nonNegative, structureExact: boolSchema,
      },
    },
    ...
    comparatorExpected: exactObject(comparatorExpectedKeys, {
      ...
      finalLedgerSha256: sha256, finalStructureSha256: sha256, databaseT0: utc, maximumQuiescenceWindowSeconds: { const: 600 },
    }),
    grant: exactObject(['grantee', 'privilege', 'grantable'], { grantable: boolSchema }),
    postApplyProof: exactObject(postApplyProofKeys, { captured_at_utc: utc, database_t0: utc, pg_net_ttl: { type: 'string', minLength: 1 }, pg_net_ttl_seconds: positive, http_queue_count: nonNegative, http_response_count: nonNegative, http_response_sha256: sha256, http_response_new_since_t0_count: nonNegative, function_execute_grants: { type: 'array', items: ref('grant') }, phase03b_versions: ref('stringArray'), phase03b_rows: ref('migrationRows') }),
    postExitProof: exactObject(postExitProofKeys, { captured_at_utc: utc, database_t0: utc, pg_net_ttl: { type: 'string', minLength: 1 }, pg_net_ttl_seconds: positive, http_queue_count: nonNegative, http_response_count: nonNegative, http_response_sha256: sha256, http_response_new_since_t0_count: nonNegative, phase03b_versions: ref('stringArray'), phase03b_rows: ref('migrationRows') }),
    comparatorStep,
  ...
  allOf: [
    { if: { properties: { phase: { const: 'ENTRY_RECEIPT' } }, required: ['phase'] }, then: { properties: {
      ...
      producer: { const: 'phase03b-r8-cutover-controller' }, expected: ref('entryExpected'), observed: ref('entryObserved'),
    } } },
    { if: { properties: { phase: { const: 'SERVER_STATE_CLASSIFICATION' } }, required: ['phase'] }, then: { properties: {
      ...
      producer: { const: 'phase03b-r8-server-adjudicator' }, expected: ref('serverExpected'), observed: ref('serverObserved'),
    } } },
    { if: { properties: { phase: { const: 'POST_APPLY_COMPARATOR' } }, required: ['phase'] }, then: { properties: {
      ...
      producer: { const: 'phase03b-r8-post-apply-verifier' }, expected: ref('comparatorExpected'), observed: ref('postApplyObserved'),
    } } },
    { if: { properties: { phase: { const: 'POST_EXIT_COMPARATOR' } }, required: ['phase'] }, then: { properties: {
      ...
      producer: { const: 'phase03b-r8-post-exit-verifier' }, expected: ref('comparatorExpected'), observed: ref('postExitObserved'),
    } } },
  ],
};

writeFileSync(join(PACKET, 'STRICT_R8_ENVELOPE_SCHEMA.json'), `${JSON.stringify(schema, null, 2)}\n`, { mode: 0o600 });

...
if (livePreflight.liveTransactionReadOnly !== true || livePreflight.productionMutations !== 'NONE' ||
    ...
    livePreflight.httpResponseFingerprintMatch !== false || livePreflight.liveReadOnlyServerStatePreflight !== 'HOLD') {
  throw new Error('R10 live evidence must preserve the read-only zero-write state and the exact pg_net fingerprint-drift HOLD');
}
...
const manifest = {
  schemaVersion: 1,
  packetVersion: 'R10',
  promptId: 'FLAGSTONE-P03B-R10-PRECLASSIFICATION-SNAPSHOT-VALIDATION-20260919',

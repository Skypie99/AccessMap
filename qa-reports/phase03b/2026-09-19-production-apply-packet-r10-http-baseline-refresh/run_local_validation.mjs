...
try {
  ...
  receipt.children.push(await run('LOCAL_R10_CONTROL_VALIDATION', 'validate_r8_controls.mjs'));
  ...
  receipt.preservedR9ReplayCheckCount = r8Checks.length - r10ValidationOrderCheckCount;
  receipt.preservedR8ReplayCheckCount = r8Checks.length - r9TransportCheckCount - r10ValidationOrderCheckCount;
  receipt.preservedR7ReplayCheckCount = r7Checks.length;
  const branchChild = receipt.children.find((child) => child.label === 'LOCAL_R10_CONTROL_VALIDATION');

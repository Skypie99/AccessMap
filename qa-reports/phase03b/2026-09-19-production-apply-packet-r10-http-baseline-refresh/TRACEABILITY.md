...
The HTTP baseline refresh is evidence maintenance, not a second repaired root defect. Provenance commit `64ee3b24e270a590656590e55312a1dd7326ab88` supported the owner-accepted `db09...9031` baseline for a bounded read-only rerun. That rerun later observed three rows and `14d0...8dfd`; the packet failed closed without retry or repinning.

...
- V2: 4 art-direction signed-in Profile captures (name/email/monogram; AXL ellipsis kept as truncation evidence). _nav/_stats KEEP_UNCHANGED (no identity on screen).
